 ...
 */
export function extractArticleTitle(htmlContent, fallbackFileName) {
 ...
 */
export function extractArticleDate(htmlContent) {
 ...
 */
export function detectArticleCategory(htmlContent) {
 ...
 */
export function extractMetadata(htmlContent, filename) {
    return {
 ...
 */
export function isValidHtml(htmlContent) {
